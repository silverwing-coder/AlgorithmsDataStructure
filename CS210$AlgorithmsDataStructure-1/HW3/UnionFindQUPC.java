 ...
 * QuickUnion with path compression algorithm implementation. June-3-2022
 ******************************************************************************/
...
public class UnionFindQUPC {

	private int[] id;
	private int[] sz;
	private int count;

	public UnionFindQUPC(int n) { // constructor() initializes number of sets = n, set id = itself
		count = n;
		id = new int[n];
		sz = new int[n];
		for (int i = 0; i < n; i++) {
...
//		String fname = "data/sec1$5/largeUF.txt";
		...
		System.out.println("Quick Union with Path Compression.");
